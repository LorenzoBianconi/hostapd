...
#define RSN_KEY_DATA_MLO_LINK_INFO_LINK_ID_MASK  0x0f
#define RSN_KEY_DATA_MLO_LINK_INFO_RSNE_PRESENT  0x10
#define RSN_KEY_DATA_MLO_LINK_INFO_RSNXE_PRESENT 0x20
